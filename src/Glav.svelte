<script>
    ...
    async function handleViewBoughtProjects() {
        navigate('/bought-projects');
    }
</script>
...
<div class="main-content">
    <div class="sidebar">
      ...
      <button class="bought-btn" on:click={handleViewBoughtProjects}>View Bought Projects</button>
      <div class="header">
            ...
            <Link to={`/EditProject/${project._id}`}>
              <li class="project-info">
                <div class="project-details">
                  ...
                  <strong>Time Created:</strong> {project.created_at} / {project.project_code}<br>
                </div>
              </li>
            </Link>
            {/each}
